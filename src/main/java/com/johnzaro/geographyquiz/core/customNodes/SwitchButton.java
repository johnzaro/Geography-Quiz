...
//		add helper button as graphic to main button
		...
		setOnMouseEntered(e -> button.setId("switch-button-hover"));
		setOnMouseExited(e -> button.setId("switch-button"));
	}
...
//	update button's UI
	public void recalculateUI(double buttonWidth, double buttonHeight, Font font)
	{
