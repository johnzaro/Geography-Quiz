...
//	--------------------- CSS ---------------------
	public static final String buttonCSS = GlobalVariables.class.getResource("/css/button.css").toExternalForm();
	public static final String checkboxCSS = GlobalVariables.class.getResource("/css/checkbox.css").toExternalForm();
	public static final String radioButtonCSS = GlobalVariables.class.getResource("/css/radioButton.css").toExternalForm();
	public static final String toggleButtonCSS = GlobalVariables.class.getResource("/css/toggleButton.css").toExternalForm();
	public static final String listViewCSS = GlobalVariables.class.getResource("/css/listView.css").toExternalForm();
	public static final String labelCSS = GlobalVariables.class.getResource("/css/label.css").toExternalForm();
	public static final String scrollPaneCSS = GlobalVariables.class.getResource("/css/scrollPane.css").toExternalForm();
	public static final String comboBoxCSS = GlobalVariables.class.getResource("/css/comboBox.css").toExternalForm();
	public static final String textAreaCSS = GlobalVariables.class.getResource("/css/textArea.css").toExternalForm();
	public static final String progressBarCSS = GlobalVariables.class.getResource("/css/progressBar.css").toExternalForm();
	public static final String sliderCSS = GlobalVariables.class.getResource("/css/slider.css").toExternalForm();
	public static final String tableViewCSS = GlobalVariables.class.getResource("/css/tableView.css").toExternalForm();
